...
"cancel",
"Add new",
"Install / Activate / Update All Plugins",
"Installing plugins, please wait.",
"All plugins are active and updated to the latest version.",
"Error occurred while performing the action",
"Please try to install/activate/update the plugin manually.",
"Add New Block",
"Close Blocks",
"RUN",
"SAVE",
"Change Image",
"Waiting plugins installation.",
...
"Use this block to add a Testimonials Slider section.",
"Add an Testimonial section.",
"Team",
"Content columns",
"Number of columns for the main content of this section.",
"Choose between three different display styles for team members.",
"Grid 1",
"Grid 2",
"Overlay display",
"Choose between two different overlays displays.",
"Slide in",
"Fade in",
...
"Slide image",
"Horizontal captions alignment",
"Vertical captions alignment",
"Middle",
"Slide Video (mp4)",
"Use this block to add a Slide to the Slider.",
"Video Lightbox",
"Will be displayed in the lightbox. Vimeo and YouTube supported.",
"Caption",
"Font",
"Alternative",
"Title small",
...
"No margin bottom",
"Splash Slider",
"Use this block to add a Slider to the Splash section.",
"Splash",
"Use this block to add a Splash section.",
"Captions alignment",
"Captions color",
"Slide ratio",
"Ratio used when this slide is displayed on mobile screens.",
"Landscape",
"Portrait",
"Square",
"Use this block to add a Slide to the Parallax slider.",
"Splash Parallax",
"Use this block to add a Parallax slider to the Splash section.",
"Video url, Vimeo or YouTube only.",
"Splash Image",
"Splash image",
"Image position",
"Use this block to add an Image to the Splash section.",
"Use this block to add a Services section.",
"Projects Grid",
"Show filters",
"Set to yes if you want to display tag based filters for the grid.",
"Full width",
"Set to yes if you want grid to take up full width of the page.",
"Grid spacing",
"Set to yes if you want grid items to have empty space around them.",
"Number of columns for the grid.",
"Captions display",
"Choose between three different captions displays.",
"Add a Projects Grid section.",
"Project Details",
"Project image",
...
"Add detail",
"Details display",
"Choose between two different display modes for the project details.",
"Horizontal",
"Vertical",
"Link text",
"Text for an optional link displayed below the project details.",
"Link url",
"Share links",
"If set to yes, share links for popular social networks will be displayed at the bottom of this section.",
"Show",
"Share text",
"Text displayed next to the share links.",
"Use this block to add a Project Details section.",
"Open in lightbox",
"Image displayed in the grid that opens the video lightbox on click.",
"Lightbox captions",
"Lightbox trigger color",
"Color of the icon that opens the video lightbox.",
"Item size",
"Normal - landscape",
"Normal - portrait",
"Large - landscape",
"Large - portrait",
"Specify the size of this item in the media grid.",
"Use this block to add a video to the media grid section.",
"Use this block to add a slide to the slider.",
"Vertically center",
"If set to yes, images that are smaller than the height of the slider will be vertically aligned in the middle.",
"Use this block to add a slider to the media grid section.",
"Media Grid",
"Use this block to add a Media Grid section.",
"Lightbox Gallery",
"Image displayed in the grid that opens the lightbox on click.",
"Choose between four different captions displays.",
"Always",
"Use this block to add a lightbox gallery to the media grid section.",
"Captions",
"Use this block to add an image to the lightbox gallery.",
"Padding",
"Background color",
"Lightbox image",
"Image displayed in the lightbox. Leave empty to use main image.",
"Image link",
"Url which should open on image click. Leave empty for images that do not link to anywhere.",
"Use this block to add an image to the media grid section.",
"Audio url, in mp3 format.",
"Image displayed in the grid behind the audio player.",
"Player color",
"Use this block to add an audio to the media grid section.",
"Title color",
"Set to Show if you want to display the divider between the section title and the rest of the content.",
"Number of columns for the logos grid.",
"Choose between different logos display styles.",
"Use this block to add a Logos section.",
"Intro",
...
"Column #1 Bg Opacity",
"Column #1 Color",
"Column #1 Show Contact Form",
"Column #1 Image",
"Column #1 Content",
"Column #1 Video",
"Column #1 Video Button Text",
"Text of the button that launches the lightbox.",
"Column #1 Content alignment",
"Column #2 Bg Color",
"Column #2 Bg Image",
"Column #2 Bg Opacity",
"Column #2 Color",
"Column #2 Show Contact Form",
"Column #2 Image",
"Column #2 Content",
"Column #2 Video",
"Column #2 Video Button Text",
"Column #2 Content alignment",
"Add a Hero section.",
"Map zoom",
"Map zoom level. 0 is fully zoomed out.",
"Add a Google Map section.",
"Marker",
"Contact",
"Use this block to add a Contact section.",
"Use this block to add a Contact Form.",
"Set to yes if you specified custom background color for this block.",
"Use this block to add a Contact Details.",
"1 Column layout",
"1/1",
"Add a Blog section showing posts in a standard blog list format.",
"Blog Grid",
"Add a Blog section showing posts in a grid format.",
"Used when linking to the block in a page (eg, from the menu).",
"Block style",
"You can enter here your custom css which will be applied to this block only through the use of style attribute.",
...
"Search",
"Alternate",
"Optional icon prepended to the menu item.",
"Mega Menu",
"Menu Title.",
"Menu Column",
"Width",
...
"1/4",
"1/6",
"Choose between different column widths.",
"Column title",
"Menu Column title",
"Default post/page",
"Minimal Main Color",
...
"Minimal General",
"Minimal Alternative",
"Pixelentity Portfolio",
"Required Plugins",
"Plugin installation isn't mandatory but some theme features won't be available without them.<br/><br/>To take full advantage of all theme features, please make sure all plugins are installed and activated by clicking the button.",
"Skin",
"Edge",
"Minimal",
...
"Bottom - transparent",
"Alternative logo",
"This logo will be displayed when header goes from transparent state to fully opaque state.",
"Menu type",
"Slide in - left",
"Slide in - right",
"Menu background",
"Menu logo",
"Header icons",
"Add one or more icon to the top menu bar.",
"Menu copyright",
...
"Footer text #3",
"Copyright",
"This is the footer copyright message displayed on the bottom of the left side of the footer area.",
"Footer links",
"Add one or more links to the footer.",
"Add Link",
"If set, it will overwrite the logo defined in Theme Options -> General.",
"Global",
"Custom Main menu",
"If you want to display custom Main menu on this page, please select one of the menus on this list.",
"Custom Side menu",
"If you want to display custom Side menu on this page, please select one of the menus on this list.",
"Footer type",
"YouTube or Vimeo url only",
"Grid size",
"Specify the size this project will take when used in Projects Grid builder module.",
"Share on Facebook",
"Share on Twitter",
"Pin on Pinterest",
