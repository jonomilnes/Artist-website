	...
	class PixelentityThemeBundledPlugins {
		...
		public function __construct($plugins) {
			...
			$this->messages = (object) array(
				'not-installed' => __('Install','nietzsche'),
				'installed' => __('Activate','nietzsche'),
				'active' => __('<i class="dashicons dashicons-yes"></i>','nietzsche'),
				'update' => __('Update','nietzsche'),
				'installing' => __('Installing','nietzsche'),
				'updating' => __('Updating','nietzsche'),
				'activating' => __('Activating','nietzsche'),
			);
		...
		public function back_action_link() {
			...
			return sprintf(
				...
				esc_url($url),
				__('Return to Theme Options','nietzsche')
			);
		}
