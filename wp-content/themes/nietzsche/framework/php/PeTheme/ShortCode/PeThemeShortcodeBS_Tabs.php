...
class PeThemeShortcodeBS_Tabs extends PeThemeShortcode {
	...
	public function __construct($master) {
		...
		$this->name = __("Tabs",'nietzsche');
		$this->description = __("Tabs",'nietzsche');
		$this->fields = array(
							  "size" =>
							  array(
									"label" => __("Number of Tabs",'nietzsche'),
									"type" => "Select",
									"single" => true,
									"description" => __("Select the number of tabs to add",'nietzsche'),
									"options" => range(1,10)
									)
							  );
