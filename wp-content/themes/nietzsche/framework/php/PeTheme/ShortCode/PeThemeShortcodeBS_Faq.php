...
class PeThemeShortcodeBS_Faq extends PeThemeShortcode {
	...
	public function __construct($master) {
		...
		$this->name = __("Faq",'nietzsche');
		$this->description = __("Faq",'nietzsche');
		$this->fields = array(
							  "title" =>
							  array(
									"label" => __("Question",'nietzsche'),
									"type" => "Text",
									"description" => __("Title of the faq.",'nietzsche'),
									"default" => "Faq Title"
									),
							  "opened" =>
							  array(
									"label" => __("Open on Page Load",'nietzsche'),
									"type" => "RadioUI",
									"description" => __("If the FAQ item should be open by default",'nietzsche'),
									"options" => PeGlobal::$const->data->yesno,
									"default" => "yes"
									),
							  "content" =>
							  array(
									"label" => __("Answer",'nietzsche'),
									"type" => "TextArea",
									"description" => __("Content of the faq.",'nietzsche'),
									"default" => "Content"
									)
							  );
