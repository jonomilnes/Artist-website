...
class PeThemeViewLayoutModulePricingTable extends PeThemeViewLayoutModuleColumns {
	...
	public function messages() {
		return
			array(
				  "title" => "",
				  "type" => __("Pricing Table",'nietzsche')
				  );
	}
	...
	public function name() {
		return __("Pricing Table",'nietzsche');
	}
	...
	public function tooltip() {
		return __("Use this block to add a pricing table module to your layout. A pricing table consists of a column based table of pricing information relating to your products or services. A pricing table may also display an optional column of row titles on the left side.",'nietzsche');
	}
