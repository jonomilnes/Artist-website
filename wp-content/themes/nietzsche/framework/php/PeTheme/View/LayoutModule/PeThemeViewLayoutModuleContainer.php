...
class PeThemeViewLayoutModuleContainer extends PeThemeViewLayoutModule {
	...
	public function messages() {
		return
			array(
				  "title" => "",
				  "type" => __("Container",'nietzsche')
				  );
	}

	public function name() {
		return __("Container",'nietzsche');
	}
	...
	public function tooltip() {
		return __("Use this block to add a container into which further blocks may then be added.",'nietzsche');
	}
