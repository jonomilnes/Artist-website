...
class PeThemeFormElementLayout extends PeThemeFormElement {
	...
	public function registerAssets() {
		...
		PeThemeAsset::addScript("framework/js/admin/jquery.theme.field.generic.js",array("pe_theme_utils","jquery-ui-sortable","pe_theme_tooltip","json2"),"pe_theme_field_generic");
		PeThemeAsset::addScript("framework/js/admin/jquery.theme.field.layout.js",array("pe_theme_field_generic","pe_theme_metabox_conditional"),"pe_theme_field_layout");
	...
	protected function template() {
		...
		$buttonLabel = __("Add New Block",'nietzsche');
		$cancelLabel = __('Close Blocks','nietzsche');
		...
		$html = <<<EOT
<div class="option pe-theme-form-element-layout" id="[ID]" data-prefix="[NAME]" data-allowed="[ALLOWED]">
	<div class="section">
