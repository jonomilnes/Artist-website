...
class PeThemeFormElementDropUpload extends PeThemeFormElement {
	...
	protected function template() {
		...
		$dropFilesHere = __("Drop files here",'nietzsche');
		$or = __("or",'nietzsche');
		$button = __("Select Files",'nietzsche');
		...
		$plupload_init = 
			json_encode(
						array(
							  ...
							  'filters'             => array(array('title' => __('Allowed Files','nietzsche'), 'extensions' => 'jpg,jpeg,gif,png')),
							  'multipart'           => true,
