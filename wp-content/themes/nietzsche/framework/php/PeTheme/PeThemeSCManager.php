...
class PeThemeSCManager {
	...
	public function admin() {
		...
		if (!(current_user_can('edit_posts') || current_user_can('edit_pages')) || empty( $this->shortcodes )) {
			return;
		}
...
EOT;
	...
	protected function post() {
		$buttonText = __("Insert Shortcode",'nietzsche');
		$html = <<< EOT
