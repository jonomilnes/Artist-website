...
<?php $view = $t->view; ?>
<?php list( $data, $bid ) = $t->template->module( 'NietzscheSplashSliderSlideCaption' ); ?>
...
<<?php esc__pe( tag_escape( $dom_element ) ); ?>
	...
	class="section section-builder section-type-splash-slider-slide-caption tms-caption letter-spaced <?php echo esc_attr( join( ' ', $classes ) ); ?>"
