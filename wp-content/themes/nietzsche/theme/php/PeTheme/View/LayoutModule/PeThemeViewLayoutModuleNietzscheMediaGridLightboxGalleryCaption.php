...
class PeThemeViewLayoutModuleNietzscheMediaGridLightboxGalleryCaption extends PeThemeViewLayoutModule {
	...
	public function fields() {
		...
		$fields = array(
			...
			'padding' => array(
				...
				'type'     => 'RadioUI',
				'options'     => array(
					__( 'Yes' ,'nietzsche') => 'padded inline',
					__( 'No' ,'nietzsche')  => '',
				),
				'default'  => '',
			),
	...
	public function templateName() {
		return 'media-grid-lightbox-gallery-caption';
	}
