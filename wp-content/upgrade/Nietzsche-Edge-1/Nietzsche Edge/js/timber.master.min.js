...
*	Version: 1.0.2
*/
!function(i,t,e,n){"use strict";var a,s=function(t,n){var a=i.extend({},i.fn.horizon.tmhOpts,n);t=i(t),b&&t.css({opacity:1,visibility:"visible"}),t.data("scrolling",!1).css("-webkit-backface-visibility","hidden");var s=(t.data("animate-in")+"").split(";");i.each(s,function(i,e){e=e.split(":");var n=e[0],a=e[1];"opacity"===n&&t.data("o",a),"scale"===n&&t.data("s",a),"easing"===n&&t.data("e",a),"transX"===n&&t.data("tx",parseFloat(a)),"transY"===n&&t.data("ty",parseFloat(a)),"transZ"===n&&t.data("tz",parseFloat(a)),"rotateX"===n&&t.data("rx",parseFloat(a)),"rotateY"===n&&t.data("ry",parseFloat(a)),"rotateZ"===n&&t.data("rz",parseFloat(a)),"duration"===n&&t.data("du",parseFloat(a)),"delay"===n&&t.data("de",parseFloat(a))}),i(e).on("scroll",function(){o(t,a)}),i(e).on("resize",function(){o(t,a)}),l(t,a),o(t,a)},o=function(i,t){i.data("scrolling")||(requestAnimationFrame(function(){c(i,t)}),i.data("scrolling",!0))},c=function(i,t){if(r(i,t)){var e=i.data("du")?i.data("du"):t.speed,n=i.data("de")?i.data("de"):0,a=i.data("e")?g[i.data("e")]:g[t.easing];h?d(i,1,0,0,0,0,0,0,1,e,n,a,t):i.css({visibility:"visible"}).stop().animate({opacity:1},t.speed,t.easingFallback,function(){t.inView&&t.inView()})}i.data("scrolling",!1)},r=function(t,n){var a=i(e).scrollTop(),s=a+i(e).height(),o=t.data("threshold")?parseFloat(t.data("threshold")):n.threshold,c=t.data("ty")?parseFloat(t.data("ty")):0,r=t.offset().top,d=t.offset().top-c,u=d+t.outerHeight()-t.outerHeight()*o,v=d+t.outerHeight()*o;return(r-a>i(e).height()||r-a<-t.outerHeight())&&(n.recurring&&l(t,n),n.outOfView&&n.outOfView()),s>=v&&u>=a},l=function(i){if(b)return!1;var t=i.data("o")?parseFloat(i.data("o")):0,e=i.data("tx")?parseFloat(i.data("tx")):0,n=i.data("ty")?parseFloat(i.data("ty")):0,a=i.data("tz")?parseFloat(i.data("tz")):0,s=i.data("rx")?parseFloat(i.data("rx")):0,o=i.data("ry")?parseFloat(i.data("ry")):0,c=i.data("rz")?parseFloat(i.data("rz")):0,r=i.data("s")?parseFloat(i.data("s")):1;i.css(h?{transition:"none",transform:"translate3d("+e+"px, "+n+"px, "+a+"px)rotate3d( 1, 0, 0, "+s+"deg )rotate3d( 0, 1, 0, "+o+"deg )rotate3d( 0, 0, 1, "+c+"deg )scale3d("+r+", "+r+", "+r+")",opacity:t,visibility:"hidden"}:{opacity:0})},d=function(t,e,n,a,s,o,c,r,l,d,u,v,h){var $={};$.transform="translate3d("+n+"px, "+a+"px, "+s+"px)rotate3d( 1, 0, 0, "+o+"deg)rotate3d( 0, 1, 0, "+c+"deg)rotate3d( 0, 0, 1, "+r+"deg)scale3d("+l+", "+l+", "+l+")",$.transitionProperty=m+", opacity",$.transitionDuration=d+"ms",$.transitionDelay=u+"ms",$.transitionTimingFunction=v,$.visibility="visible",$.opacity=e,t.css($).on(p,function(t){t.stopPropagation(),i(this).off(p),h.inView&&h.inView()})},u=t.body||t.documentElement,v=u.style,h=v.transition!==n||v.WebkitTransition!==n||v.MozTransition!==n||v.MsTransition!==n||v.OTransition!==n,$=["WebkitTransform","MozTransform","OTransform","msTransform"];for(var f in $)v[$[f]]!==n&&(a="-"+$[f].replace("Transform","").toLowerCase());var m=a+"-transform",p="webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",g={linear:"cubic-bezier(0, 0, 1, 1)",swing:"cubic-bezier(0.42, 0, 0.58, 1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)",easeFastSlow:"cubic-bezier(.11,.69,.66,1.01)",easeBounceBack:"cubic-bezier(.18,1.92,.59,1.33)",easeBounceBackHard:"cubic-bezier(.8,1.91,0,.94)",easeHickUp:"cubic-bezier(.28,1.78,.01,0)"},b=!1;(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i))&&(b=!0),function(){for(var i=0,t=["ms","moz","webkit","o"],n=0;n<t.length&&!e.requestAnimationFrame;++n)e.requestAnimationFrame=e[t[n]+"RequestAnimationFrame"],e.cancelAnimationFrame=e[t[n]+"CancelAnimationFrame"]||e[t[n]+"CancelRequestAnimationFrame"];e.requestAnimationFrame||(e.requestAnimationFrame=function(t){var n=(new Date).getTime(),a=Math.max(0,16-(n-i)),s=e.setTimeout(function(){t(n+a)},a);return i=n+a,s}),e.cancelAnimationFrame||(e.cancelAnimationFrame=function(i){clearTimeout(i)})}(),i.fn.horizon=function(t){return this.each(function(){var e=i(this);if(!e.data("horizon")){var n=new s(this,t);e.data("horizon",n)}})},i.fn.horizon.tmhOpts={easing:"swing",easingFallback:"swing",speed:500,threshold:1,recurring:!0,inView:null,outOfView:null}}(jQuery,document,window);
/**
